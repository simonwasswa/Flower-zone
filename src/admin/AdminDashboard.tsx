  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#f7edeb] px-5 py-12">
      ...
      <div className="relative w-full max-w-md rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-[0_28px_80px_rgba(91,52,53,.14)] backdrop-blur sm:p-9">
        <a href="/" className="mx-auto block h-20 w-28" aria-label="Return to Flower Zone">
        ...
        <a href="/" className="mt-6 flex items-center justify-center gap-2 text-sm font-semibold text-[#9d5558] hover:text-[#302827]">Return to website <ExternalLink size={15} /></a>
      </div>
    </main>
  );
}
    ...
    <section>
      ...
      <div className="mt-8 rounded-2xl border border-[#eadfdd] bg-white p-5 shadow-sm sm:p-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <a href="/" target="_blank" rel="noreferrer" className="hidden min-h-10 items-center gap-2 rounded-full border border-[#dbc8c5] px-4 text-sm font-semibold text-[#9d5558] hover:bg-[#fff8f7] sm:inline-flex">View site <ExternalLink size={15} /></a>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#f8f3f2] text-[#302827]">
      <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-[#e7d9d7] bg-white/95 px-4 backdrop-blur lg:hidden">
        ...
        <a href="/" className="grid h-10 w-10 place-items-center rounded-full text-[#9d5558] hover:bg-[#f5e8e7]" aria-label="View website"><ExternalLink size={18} /></a>
      </header>
      ...
      <aside className={`${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 flex w-[285px] flex-col border-r border-[#e7d9d7] bg-white transition-transform lg:translate-x-0`}>
        ...
        <div className="border-t border-[#eee3e1] p-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <a href="/" target="_blank" rel="noreferrer" className="inline-flex min-h-10 items-center justify-center gap-2 rounded-xl border border-[#e0d0ce] text-xs font-semibold text-[#756765] hover:bg-[#fff8f7]"><ExternalLink size={14} /> Website</a>
