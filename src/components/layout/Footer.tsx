      ...
      <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-5 border-t border-line pt-6 text-center sm:flex-row sm:text-left">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:hello@flowerzone.com" aria-label="Email" className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-white transition-transform hover:scale-105">
